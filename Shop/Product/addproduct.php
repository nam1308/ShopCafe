...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Thêm San Pham</h1>
    ...
    <div class="form-row">
        ...
        <input type="text" class="form-control" id="inputEmail4" name="tensp" placeholder="Ten san pham" value="">
       ...
       <input type="hidden" class="form-control" name="stt[]" value="">
            <div class="d-flex">
                <input type="file" class="form-control" name="anhsp[]" id="anhsp" multiple placeholder="file" value="">
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" name="mota" id="ghichu" placeholder="Mo ta"></textarea>
    </div>
